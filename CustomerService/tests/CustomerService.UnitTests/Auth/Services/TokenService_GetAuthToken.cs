      ...
      .Setup(_ => _.WriteToken(
        It.Is<JwtSecurityToken>(
          i => i.Issuer == _options.Issuer &&
               ...
               i.ValidTo.ToLocalTime().ToString(CultureInfo.CurrentCulture) == DateTime.Now
                 .AddHours(_options.LifeTimeHours)
