using CustomerService.Core.ContributorAggregate.Events;
using CustomerService.Core.ProjectAggregate.Specifications;
using SharedKernel.Interfaces;
using MediatR;

namespace CustomerService.Core.ProjectAggregate.Handlers;
