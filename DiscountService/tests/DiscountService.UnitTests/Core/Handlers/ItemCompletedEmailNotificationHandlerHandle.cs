...
using DiscountService.Core.ProjectAggregate.Events;
using DiscountService.Core.ProjectAggregate.Handlers;
using Moq;
using Xunit;

namespace DiscountService.UnitTests.Core.Handlers;
